...
import uit.pubguru.dto.JournalDTO;
...
public class JournalMapper extends MapperDB {
    ...
    public int isExisted(JournalDTO journalDTO) throws Exception {
        ...
        try {
            ...
            sql.append(" SELECT * FROM " + PubGuruDB.DBNAME + "." + "journal journal");
    ...
    public int insertObj(JournalDTO journalDTO) throws Exception {                
        try {
            StringBuffer sql = new StringBuffer();
            sql.append("INSERT INTO " + PubGuruDB.DBNAME + "." + "journal(journalName, website, yearStart, yearEnd, organization, url) ");
            sql.append(" VALUES(?, ?, ?, ?, ?, ?)");
    ...
    public int updateObj(JournalDTO journalDTO) throws Exception {
    	 try {
    	     StringBuffer sql = new StringBuffer();
             sql.append("UPDATE " + PubGuruDB.DBNAME + "." + "journal");
    ...
    public JournalDTO getJournalDTO(int idJournal) throws Exception{
        ...
        try {
            StringBuffer sql = new StringBuffer();
            sql.append(" SELECT * FROM " + PubGuruDB.DBNAME + "." + "journal j");
    ...
    public ArrayList getJournalIdList() throws Exception{
        ...
        try {
            StringBuffer sql = new StringBuffer();
            sql.append(" SELECT j.idJournal FROM " + PubGuruDB.DBNAME + "." + "journal j ORDER BY j.idJournal");
            PreparedStatement stmt = getConnection().prepareStatement(sql.toString());
            ResultSet rs = stmt.executeQuery();
            while ((rs != null) && (rs.next())) {
