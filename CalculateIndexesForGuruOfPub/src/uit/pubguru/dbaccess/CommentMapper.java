...
import uit.pubguru.dto.CommentDTO;
...
public class CommentMapper extends MapperDB {
    ...
    public int insertObj(CommentDTO objDTO) throws Exception {
        try {
            ...
            sql.append("INSERT INTO " + PubGuruDB.DBNAME + "." + "Comment(rating,"
                    + " content, idPaper)");                                          
            sql.append(" VALUES(?,?,?)");
    ...
    public int isExisted(CommentDTO objDTO) throws Exception {        
        ...
        try {
            StringBuffer sql = new StringBuffer();
            sql.append(" SELECT * FROM " + PubGuruDB.DBNAME + "." + "Comment");
    ...
    public int updateObj(CommentDTO objDTO) throws Exception {
        try {
            StringBuffer sql = new StringBuffer();
            sql.append("UPDATE " + PubGuruDB.DBNAME + "." + "Comment");                                          
