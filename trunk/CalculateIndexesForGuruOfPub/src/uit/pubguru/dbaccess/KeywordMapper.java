...
import uit.pubguru.dto.KeywordDTO;
...
public class KeywordMapper extends MapperDB {
    ...
    public int insertObj(KeywordDTO objDTO) throws Exception {
        try {
            ...
            sql.append("INSERT INTO " + PubGuruDB.DBNAME + "." + "Keyword(keyword,"
    ...
    public int isExisted(KeywordDTO objDTO) throws Exception {        
        ...
        try {
            StringBuffer sql = new StringBuffer();
            sql.append(" SELECT * FROM " + PubGuruDB.DBNAME + "." + "Keyword");
    ...
    public int updateObj(KeywordDTO objDTO) throws Exception {
        try {
            StringBuffer sql = new StringBuffer();
            sql.append("UPDATE " + PubGuruDB.DBNAME + "." + "Keyword");                                          
    ...
    public KeywordDTO getKeywordDTO(int idKeyword) throws Exception{
        ...
        try {
            StringBuffer sql = new StringBuffer();
            sql.append(" SELECT * FROM " + PubGuruDB.DBNAME + "." + "Keyword k");
    ...
    public ArrayList getKeywordIdList() throws Exception{
        ...
        try {
            StringBuffer sql = new StringBuffer();
            sql.append(" SELECT k.idKeyword FROM " + PubGuruDB.DBNAME + "." + "Keyword k ORDER BY k.idKeyword");
            PreparedStatement stmt = getConnection().prepareStatement(sql.toString());
            ResultSet rs = stmt.executeQuery();
            while ((rs != null) && (rs.next())) {
