...
import uit.guruofpub.dto.DomainDTO;
/**
 *
 * @author Loc Do
 * @author Nghiep Tran
...
public class DomainMapper extends MapperDB {
    ...
    public int insertObj(DomainDTO objDTO) throws Exception {
        try {
            ...
            sql.append("INSERT INTO guruofpub.domain(domainName)");                                          
            sql.append(" VALUES(?)");
    ...
    public int isExisted(DomainDTO objDTO) throws Exception {        
        ...
        try {
            StringBuffer sql = new StringBuffer();
            sql.append(" SELECT * FROM guruofpub.domain d");
    ...
    public int updateObj(DomainDTO objDTO) throws Exception {
        try {
            StringBuffer sql = new StringBuffer();
            sql.append("UPDATE guruofpub.domain d");                                          
